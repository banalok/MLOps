...
# the EDA done in the notebook has been implemented here in sequence for modifying features
...
if __name__ == "__main__":
    for ind in range(1,4):
        # read the input file name from command i.e. [0: python .\src\features\modify_features.py 1: data/interim/train.csv 2: data/interim/val.csv 3: data/raw/extracted/test.csv] in dvc.yaml
